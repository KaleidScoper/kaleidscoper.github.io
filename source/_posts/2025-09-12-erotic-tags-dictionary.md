...
- 资料来源包括：  
  - 日本、韩国二次元/成人社区标签用法；  
  - 英文色情网站（如 Pornhub、XVideos 等）的分类体系；  
  - AO3 的标签与 Archive Warnings；  
  - Wikipedia 与学术研究对“ero-guro”等词源的解释。  

---

## 结语
本对照表展示了“标签”作为跨文化语义工具的复杂性。标签既是用户检索的导航，也是文化差异的缩影。部分标签已成为“全球通用语”，部分标签则深嵌于特定次文化的叙事习惯中。  
未来随着全球色情内容的进一步网络化，<b>多语言标签库的统一与差异化并存</b>的现象会愈发显著。
